//    This report uses the same layout as the Statement Cr.Memo report.
report 5266007 "lbt com Statement Invoice"
{

    Caption = 'Commission Statement', Comment = 'DEU="Provisionsabrechnung"';
    ...
    dataset
    {
        ...
        dataitem("Purch. Inv. Header"; "Purch. Inv. Header")
        {
            ...
            RequestFilterHeading = 'Posted Purchase Invoice', Comment = 'DEU="Geb. Einkaufsrechnung"';
            ...
            column(PurchInvHeader_DocDate; "Purch. Inv. Header"."Document Date") { }
            ...
            column(BuyFromVendorNo; "Purch. Inv. Header"."Buy-from Vendor No.") { }
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem("Purch. Inv. Line"; "Purch. Inv. Line")
                {
                    ...
                    #endregion columns
                    //column(STRSUBSTNO___1__2__Format(_Purch__Inv__Line___Direct_Unit_Cost_Price_Factor____100_0___Sign__Integer__Decimals_3________; STRSUBSTNO('%1 %2', Format("Purch. Inv. Line"."Direct Unit Cost Price Factor" * 100, 0, '<Sign><Integer><Decimals,3>'), '%')) { }
                    #region columns
                    ...
                    begin
                        ...
                        TypeNo := Type;
                        // PrintOptionNo := "Purch. Inv. Line".Printoption;
                ...
                dataitem(VATClauseEntryCounter; Integer)
                {
                    ...
                    begin
                        ...
                        if not VATClause.Get(TempVATAmountLine."VAT Clause Code") then
                            CurrReport.Skip();
                        VATClause.TranslateDescription("Purch. Inv. Header"."Language Code");
                    end;
                    #endregion OnAfterGetRecord
                }
                ...
                dataitem("Extended Text Header"; "Extended Text Header")
                {
                    ...
                    begin
                        ...
                        SetRange("Language Code", "Purch. Inv. Header"."Language Code");
            ...
            begin
                ...
                VendRec.Get("Purch. Inv. Header"."Pay-to Vendor No.");
                ...
                if Vendor.Get("Purch. Inv. Header"."Buy-from Vendor No.") then;  //für Vat Reg.Nr.
    ...
    #endregion GetOrdinalText

    #region SetPeriodMonthly
    local procedure SetPeriodMonthly()
    begin
        DateRec.Reset();
        DateRec.SetRange("Period Type", DateRec."Period Type"::Month);
        DateRec.SetRange("Period Start", 0D, "Purch. Inv. Header"."Posting Date");
        if DateRec.FindLast() then
            Period := DateRec."Period Name" + ' ' + Format(Date2DMY("Purch. Inv. Header"."Posting Date", 3));
    end;
    #endregion SetPeriodMonthly

    #region SetPeriodQuarterly
    ...
    begin
        ...
        Period := Period + ' ' + Format(Date2DMY("Purch. Inv. Header"."Posting Date", 3));
    end;
    #endregion SetPeriodQuarterly

    #region SetPeriodBiannually
    local procedure SetPeriodBiannually()
    begin
        if Date2DMY("Purch. Inv. Header"."Posting Date", 2) <= 6 then
            Period := '1'
        else
            Period := '2';
    ...
    #endregion GetCompanyInfo

    #region SetHeaderAnschrift
    ...
    #endregion SetHeaderAnschrift

    #region SetSalutation
    local procedure SetSalutation()
    begin
        if Vendor."Primary Contact No." <> '' then
            if ContRec.Get(Vendor."Primary Contact No.") then
                ContactAnrede := ContRec.GetSalutation(Enum::"Salutation Formula Salutation Type"::Formal, "Purch. Inv. Header"."Language Code") + ',';
        if ContactAnrede = '' then
            ContactAnrede := SalutationTxt;
    end;
    #endregion SetSalutation
    ...
    var
        ...
        CommissionStatementCaptionLbl: Label 'Commission statement:', Comment = 'DEU="Provisionsabrechnung:"';
